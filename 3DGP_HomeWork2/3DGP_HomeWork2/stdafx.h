...
namespace Vector3
{
	...
	{
		XMFLOAT3 m_xmf3Noraml;
		XMStoreFloat3( &m_xmf3Noraml, XMVector3Normalize( XMLoadFloat3( &xmf3Vector ) ) );
	...
	{
		XMMATRIX xmmtxMatrix = XMLoadFloat4x4( &xmmtx4x4Matrix );

		return(TransformCoord( xmf3Vector, xmmtxMatrix ));
